  ...
  divContainer.innerHTML += `
    <div class= "movie_container"  id = "remove-btn-moiveId-${movies.id}">
      <div class="remove_container">
        <svg width="25pt" height="25pt" version="1.1" viewbox="0 0 700 700" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class= "remove_icon_btn remove_icon_btn_movieId_${movies.id} remove_icon_btn_listId_${listId}">
          <defs>
          ...
          <g>
              <path d="m159.94 89.938c-37.594 37.59-63.199 85.484-73.57 137.63-10.375 52.141-5.0508 106.19 15.293 155.31s54.797 91.098 99 120.64c44.203 29.535 96.176 45.301 149.34 45.301s105.14-15.766 149.34-45.301c44.203-29.539 78.656-71.52 99-120.64s25.668-103.17 15.293-155.31c-10.371-52.145-35.977-100.04-73.57-137.63-50.406-50.406-118.78-78.727-190.06-78.727s-139.66 28.32-190.06 78.727zm296.8 249.48-47.543 47.543-59.195-59.418-59.414 59.359-47.543-47.543 59.414-59.359-59.359-59.414 47.543-47.543 59.359 59.414 59.414-59.359 47.543 47.543-59.414 59.359z"></path>
          </g>
        </svg>
